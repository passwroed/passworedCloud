...
import cn.passwored.commons.core.util.HumpUtil;
...
public class ApiResponse <T> implements Serializable {
    ...
    public void setSubjoin(Object subjoin) {
     ...
     * @return ApiResponse
     */
    public static <T> ApiResponse<T> buildSuccessResponse(int total, Object obj, Object subjoin) {
        ApiResponse<T> apiResponse = buildSuccessResponse(obj);
        apiResponse.setTotal(total);
        apiResponse.setSubjoin(subjoin);
        return apiResponse;
    }
