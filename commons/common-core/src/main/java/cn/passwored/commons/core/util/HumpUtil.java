package cn.passwored.commons.core.util;
...
public class HumpUtil {
    ...
    public static Map lineToHump(Map<String, Object> params) {
        ...
        for (Map.Entry<String, Object> entry : params.entrySet()) {
            ...
            try {
                if (newKey.toLowerCase().contains("date") || newKey.toLowerCase().contains("time")) {
                    entryValue = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(entry.getValue());
                }
            } catch (Exception e) {
            }

            resultMap.put(newKey, entryValue);
        }
        return resultMap;
    }
